...
const CheckboxModal = () => {
  ...
  return (
    <div className="bg-white text-[#1F2128] border-[#EEEEEE] items-center py-[10px] rounded-[6px] text-[14px] border min-w-[300px] sm:min-w-[370px] font-montserrat flex flex-col justify-between shadow-[0px_8px_15px_0px_#1414141F,_0px_0px_4px_0px_#1414141A]">
